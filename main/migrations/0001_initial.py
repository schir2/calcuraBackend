# Generated by Django 5.1.4 on 2025-02-28 05:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.CharField(choices=[('monthly', 'Monthly'), ('weekly', 'Weekly'), ('biweekly', 'Biweekly'), ('quarterly', 'Quarterly'), ('annual', 'Annually'), ('one_time', 'One Time')], max_length=50, verbose_name='Frequency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.CharField(choices=[('weekly', 'Weekly'), ('monthly', 'Monthly'), ('quarterly', 'Quarterly'), ('annual', 'Annual')], default='annual', max_length=50, verbose_name='Frequency')),
                ('creator', django_currentuser.db.models.fields.CurrentUserField(default=django_currentuser.middleware.get_current_authenticated_user, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='created_%(class)s', to=settings.AUTH_USER_MODEL, verbose_name='Creator')),
                ('editor', django_currentuser.db.models.fields.CurrentUserField(default=django_currentuser.middleware.get_current_authenticated_user, null=True, on_delete=django.db.models.deletion.CASCADE, on_update=True, related_name='edited_%(class)s', to=settings.AUTH_USER_MODEL, verbose_name='Editor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iras', models.ManyToManyField(related_name='plans', to='main.ira', verbose_name='IRA  Configurations')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='plan',
            name='roth_iras',
            field=models.ManyToManyField(related_name='plans', to='main.rothira', verbose_name='Roth IRA  Configurations'),
        ),
        migrations.CreateModel(
